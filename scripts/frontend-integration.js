 ...
 * This file demonstrates how to integrate Audacityloom with a web frontend
 */

// For React/Vue/Angular applications
export class AudacityloomClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new AudacityloomClient(provider, contractAddress);
