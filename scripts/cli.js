...
const contractABI = require("../artifacts/contracts/Audacityloom.sol/Audacityloom.json").abi;

program
    .name("audacityloom-cli")
    .description("CLI tool for Audacityloom smart contract")
    .version("1.0.0");
